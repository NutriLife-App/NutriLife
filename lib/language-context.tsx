...
const translations = {
  ua: {
    ...
    "hero.subheadline": "NutriLife - це smart nutrition assistant, який допомагає створити зручний раціон під ваші цілі, бюджет, уподобання та продукти, які справді можна купити поруч.",
