...
const translations = {
  ua: {
    ...
    "hero.subheadline": "NutriLife App - це персональний помічник зі здорового харчування, який допомагає складати зручний раціон під ваші цілі, бюджет і вподобання з урахуванням продуктів, які реально можна купити поруч.",
