...
function LanguageSwitcher({
  ...
  return (
    ...
    >
      ...
      <span
        aria-hidden="true"
        className={`pointer-events-none absolute top-1/2 left-[3px] -translate-y-1/2 ${sizeStyles.pillH} w-[calc(50%-3px)] rounded-full bg-primary shadow-sm transition-transform duration-300 ease-[cubic-bezier(0.34,1.2,0.64,1)] ${isEn ? "translate-x-[calc(100%)]" : "translate-x-0"}`}
      />
